...
public class ApiExceptionHandler {
    ...
    @ResponseBody
    public ErrorMessage forbiddenRequest (HttpServletRequest request, Exception ex) {
        return new ErrorMessage(ex, request.getRequestURI());
    }
    ...
    @ResponseBody
    public ErrorMessage conflictRequest (HttpServletRequest request, Exception ex) {
        return new ErrorMessage(ex, request.getRequestURI());
    }
    ...
    @ResponseBody
    public ErrorMessage fatalErrorUnexpectedException (HttpServletRequest request, Exception ex) {
        return new ErrorMessage(ex, request.getRequestURI());
    }
}
